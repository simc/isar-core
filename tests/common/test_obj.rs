...
impl TestObj {
    ...
    pub fn default_indexes() -> Vec<IndexSchema> {
        vec![
            ...
            IndexSchema::new(vec![Self::long_index()], false, false),
            IndexSchema::new(vec![Self::float_index()], false, false),
            IndexSchema::new(vec![Self::double_index()], false, false),
            IndexSchema::new(vec![Self::string_index(false, true)], false, false),
            IndexSchema::new(vec![Self::byte_list_index(false)], false, false),
            IndexSchema::new(vec![Self::int_list_index(false)], false, false),
            IndexSchema::new(vec![Self::long_list_index(false)], false, false),
            IndexSchema::new(vec![Self::float_list_index(false)], false, false),
            IndexSchema::new(vec![Self::double_list_index(false)], false, false),
            IndexSchema::new(
    ...
    pub fn save(&self, txn: &mut IsarTxn, col: &IsarCollection) {
        ...
        col.put(txn, self.id, IsarObject::from_bytes(&bytes))
            .unwrap();
    }
}
